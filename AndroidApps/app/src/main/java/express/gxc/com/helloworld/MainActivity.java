package  express.gxc.com.helloworld;
...
import express.gxc.com.helloworld.R;

public class MainActive extends Activity implements OnClickListener{
    private static String TAG = MainActive.class.getSimpleName();
    // 语音识别对象
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        // 获取联系人，本地更新词典时使用
        ContactManager mgr = ContactManager.createManager(MainActive.this, mContactListener);
